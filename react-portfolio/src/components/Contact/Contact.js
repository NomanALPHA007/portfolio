          ...
          <div className="contact__info" data-aos="fade-up">
            ...
            <div className="contact__info-details">
              <ul>
                ...
                <li>
                  ...
                  <p>
                    <span>Email:&nbsp;&nbsp;</span>ehtasham@graduate.utm.my
                  </p>
                </li>
                <li>
                  {" "}
            ...
            <div className="contact__social">
              <p className="contact__linkedin">
                <a
                  href="https://www.linkedin.com/in/ehtasham-al-noman/"
              ...
              <p className="contact__github">
                <a
                  href="https://github.com/NomanALPHA007"
                  rel="noopener noreferrer"
                  target="_blank"
                >
              ...
              <p className="contact__youtube">
                <a
                  href="https://www.youtube.com/channel/UCJHAKPEcLoE4-OnUfuOFPFQ"
                  rel="noopener noreferrer"
                  target="_blank"
                >
